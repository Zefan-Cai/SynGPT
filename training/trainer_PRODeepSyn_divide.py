...
from datasets.dataloader_PRODeepSyn import (
    PRODeepSyn_dataset,
    PRODeepSyn_dataloader
)
from models.PRODeepSyn import DNN
...
class Trainer(object):
    def __init__(self, args):
        ...
        # warmup
        self.warmup_dataset = PRODeepSyn_dataset(self.args, type="warmup")
        self.warmup_dataloader = PRODeepSyn_dataloader(self.args, self.warmup_dataset)
        ...
        # warmup
        self.noisylabel_warmup_dataset = PRODeepSyn_dataset(self.args, type="noisylabel and warmup")
        self.noisylabel_warmup_dataloader = PRODeepSyn_dataloader(self.args, self.noisylabel_warmup_dataset)
