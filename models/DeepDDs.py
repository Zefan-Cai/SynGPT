...
class GCNNet(torch.nn.Module):
    def __init__(self, args, n_output=2, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=37261, output_dim=128, dropout=0.2):
    ...
    def fix_GNN(self):
        for name, param in self.named_parameters():
            if 'seq' in name or "fc1" in name or "fc2" in name or "out" in name:
